  ...
  return (
    <Container width="80vw" height="130vh" flexDirection="column" justifyContent="start" padding="5vh 0 0 0">
      ...
      <Container width="80vw" height="10vh" flexDirection="row" alignItems="center" gap="4rem">
        ...
        <Container width="10vw" height="5vh" flexDirection="row" alignItems="center" justifyContent="start" gap="1rem">
      ...
      <Container width="80vw" height="10vh" flexDirection="row" alignItems="center" justifyContent="end" gap="4rem">
        <Button cor="branco" texto="Importar via texto"/>
      </Container>

      {/* WRAPPER CARDS DE CRIACAO */}
      <Container width="80vw" height="85vh" flexDirection="column" alignItems="center" justifyContent="start" margin="1rem 0">
        <Container width="80vw" height="10vh" flexDirection="column" alignItems="center" justifyContent="center">
          <h4>Cartões</h4> 
        </Container>
